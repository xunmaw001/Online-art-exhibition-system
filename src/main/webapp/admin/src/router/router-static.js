...
import center from '@/views/center'
    ...
    import zuojiajiedan from '@/views/modules/zuojiajiedan/list'
    import yonghu from '@/views/modules/yonghu/list'
    import discusszuojiazuopin from '@/views/modules/discusszuojiazuopin/list'
    import zuojiazuopin from '@/views/modules/zuojiazuopin/list'
...
const routes = [{
	...
	path: '/yonghu',
      ...
      ,{
	path: '/discusszuojiazuopin',
        name: '作家作品评论',
        component: discusszuojiazuopin
      }
      ,{
	path: '/zuojiazuopin',
        name: '作家作品',
        component: zuojiazuopin
      }
      ,{
	path: '/dingdanxinxi',
        name: '订单信息',
