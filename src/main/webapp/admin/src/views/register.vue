  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(0, 150, 136, 1);fontSize:28px;">在线画展系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='zuojia'" class="input-group">
			   <div class="label">作家账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zuojiazhanghao" class="input" type="text" placeholder="作家账号">
			   </div>
			 </div> -->
			<el-form-item label="作家账号" class="input" v-if="tableName=='zuojia'">
			  <el-input v-model="ruleForm.zuojiazhanghao" autocomplete="off" placeholder="作家账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zuojia'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='zuojia'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='zuojia'" class="input-group">
			   <div class="label">作家姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zuojiaxingming" class="input" type="text" placeholder="作家姓名">
			   </div>
			 </div> -->
			<el-form-item label="作家姓名" class="input" v-if="tableName=='zuojia'">
			  <el-input v-model="ruleForm.zuojiaxingming" autocomplete="off" placeholder="作家姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zuojia'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='zuojia'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zuojia'" class="input-group">
			   <div class="label">手机</div>
			...
			<el-form-item label="手机" class="input" v-if="tableName=='zuojia'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.nianling) && `zuojia` == this.tableName){
        this.$message.error(`年龄不能为空`);
        return
      }
      if((!this.ruleForm.shouji) && `zuojia` == this.tableName){
        this.$message.error(`手机不能为空`);
        return
      }
      if(`zuojia` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
      this.$http({
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210526/4642462771f143b2910c548088a328c1.jpg");
		height: 100vh;
