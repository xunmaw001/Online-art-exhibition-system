    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="订单要求" prop="dingdanyaoqiu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.dingdanyaoqiu" label="订单要求" prop="dingdanyaoqiu">
                    <span v-html="ruleForm.dingdanyaoqiu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.dingdanyaoqiu = this.ruleForm.dingdanyaoqiu.replace(reg,'../../../ssmz87jd/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yonghudingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yonghudingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
