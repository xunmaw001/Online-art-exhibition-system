<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="订单标题" prop="dingdanbiaoti">
          <el-input v-model="ruleForm.dingdanbiaoti" 
              placeholder="订单标题" clearable  :readonly="ro.dingdanbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="订单标题" prop="dingdanbiaoti">
              <el-input v-model="ruleForm.dingdanbiaoti" 
                placeholder="订单标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.zuopin" label="作品" prop="zuopin">
          <file-upload
          tip="点击上传作品"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zuopin" label="作品" prop="zuopin">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zuopin.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dingdanbianhao = true;
          ...
          if(o=='dingdanbiaoti'){
            this.ruleForm.dingdanbiaoti = obj[o];
	    this.ro.dingdanbiaoti = true;
            continue;
          }
          if(o=='zuopin'){
      ...
      this.$http({
		...
		if(json.zuojiaxingming!=''&&json.zuojiaxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.dingdanzhuangtaiOptions = "已完成,未完成".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
