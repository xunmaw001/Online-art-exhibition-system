                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="zuopin"
                    ...
                    <template slot-scope="scope">
                      <div v-if="scope.row.zuopin">
                        <img :src="scope.row.zuopin.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          dingdanbiaoti: row.dingdanbiaoti,
          zuopin: row.zuopin,
          jiage: row.jiage,
          ...
          zuojiazhanghao: row.zuojiazhanghao,
          zuojiaxingming: row.zuojiaxingming,
          sfsh: row.sfsh,
          shhf: row.shhf,
          ispay: row.ispay,
          id: row.id
